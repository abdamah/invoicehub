      ...
      <div className="grid min-h-screen w-full md:grid-cols-[220px_1fr] lg:grid-cols-[280px_1fr]">
        <div className="hidden border-r bg-muted/40 md:block">
          <div className="flex flex-col max-h-screen h-full gap-2">
            <div className="h-14 flex items-center border-b  px-4 lg:h-16 lg:px-6">
              <Link href="/" className="flex items-center gap-2">
                <Image src={Logo} alt="logo" className="size-7" />
                <p className="text-2xl font-bold">
                  Invoice<span className="text-blue-600">Hub</span>
                </p>
              </Link>
            </div>
          ...
          <header className="flex h-14 items-center gap-4 border-b bg-muted/40 px-4 lg:h-16 lg:px-6">
            <Sheet>
              ...
              <SheetContent side="left">
                <SheetDescription className="text-xl font-bold hidden">
                  Menu
                </SheetDescription>
