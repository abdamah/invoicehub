    ...
    <section className="relative flex flex-col items-center justify-center py-12 lg:py-20">
      <div className="text-center">
        ...
        <p className="max-w-xl mx-auto mt-4 lg:text-lg text-muted-foreground">
          ...
          <span className="bg-gradient-to-l from-blue-700 via-teal-500 to-green-500 text-transparent bg-clip-text font-semibold">
            InvoiceHub
          </span>{" "}
          make it super easy for you to get{" "}
          <span className="bg-gradient-to-l from-blue-500 via-teal-500 to-green-500 text-transparent bg-clip-text font-semibold">
            paid
          </span>{" "}
          in time.
        </p>
      ...
      <div
        className="relative
       items-center w-full py-5 mx-auto mt-12"
      >
        <svg
        ...
        <Image
          src={HeroImage}
          alt="Hero image"
          className="relative object-cover w-full border rounded-lg lg:rounded-3xl shadow-2xl"
        />
      </div>
    </section>
  );
